...
function flowProcessListMonitoring() {
...
function initFlowProcessDatatablePage(testTableId, url) {
        ...
        for (var i = 0; i < resPageData.length; i++) {
            ...
            if (resPageData[i]) {
                ...
                var actionsHtmlStr = '<p style="width: 100%; text-align: center" >' +
                    '<a class="btn" ' +
                    'href="/piflow-web/process/getProcessById?processId=' + resPageData[i].id + '&parentAccessPath=flowProcess" ' +
                    'target="_blank" ' +
