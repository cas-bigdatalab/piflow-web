...
ALTER TABLE `FLOW_STOPS_PROPERTY` ADD COLUMN `EXAMPLE` TEXT COMMENT 'property example';
ALTER TABLE FLOW_STOPS_PROPERTY_TEMPLATE ADD COLUMN `EXAMPLE` TEXT COMMENT 'property example';
