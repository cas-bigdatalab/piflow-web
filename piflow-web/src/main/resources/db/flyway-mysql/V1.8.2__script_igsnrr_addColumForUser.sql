...
ALTER TABLE sys_user ADD phone_number varchar(40) NULL DEFAULT "" COMMENT '联系电话';
ALTER TABLE sys_user ADD email varchar(40) NULL DEFAULT "" COMMENT '联系邮箱';
...
ALTER TABLE data_product ADD doi_id varchar(100) NULL DEFAULT "" COMMENT 'DOI标识';
ALTER TABLE data_product ADD cstr_id varchar(100) NULL DEFAULT "" COMMENT 'CSTR标识';
ALTER TABLE data_product ADD subject_type_id varchar(40) NULL DEFAULT "" COMMENT '学科分类id';
ALTER TABLE data_product ADD time_range varchar(100) NULL DEFAULT "" COMMENT '时间范围';
ALTER TABLE data_product ADD spacial_range varchar(100) NULL DEFAULT "" COMMENT '空间范围';
ALTER TABLE data_product ADD dataset_size varchar(100) NULL DEFAULT "" COMMENT '存储量' after `dataset_url`;
ALTER TABLE data_product ADD dataset_type tinyint(1) DEFAULT 0 NOT NULL COMMENT '数据集类型 0-电子表格 1-数据库';
ALTER TABLE data_product ADD associate_id varchar(256) NULL DEFAULT NUll COMMENT '关联的数据产品id，多个用英文分号隔开';
