...
insert into `data_product_type` (`id`, `parent_id`, `level`, `name`, `description`, `crt_dttm`, `crt_user`, `enable_flag`, `last_update_dttm`, `last_update_user`, `version` ) values ('2','0', '1', '生态系统服务功能数据产品', '生态系统服务功能数据产品', NOW(), 'admin', b'1', NOW(), 'admin', 0 );
insert into `data_product_type` (`id`, `parent_id`, `level`, `name`, `description`, `crt_dttm`, `crt_user`, `enable_flag`, `last_update_dttm`, `last_update_user`, `version` ) values ('3','1', '2', '大气环境要素观测数据产品', '参照气象行业标准《地面气象观测资料质量控制》，对自动气象观测站观测的逐时地面气象要素（气温、降水量、湿度、风速、大气压等）和辐射要素数据（L0级数据）进行质量控制、数据插补和统计分析等处理，生成日尺度、月尺度和年尺度的大气环境要素数据产品（L1-L3级数据）。', NOW(), 'admin', b'1', NOW(), 'admin', 0 );
insert into `data_product_type` (`id`, `parent_id`, `level`, `name`, `description`, `crt_dttm`, `crt_user`, `enable_flag`, `last_update_dttm`, `last_update_user`, `version` ) values ('4','1', '2', '生物要素观测数据产品', '对生物量、植物种类组成、凋落物、物候期等观测数据进行质量控制和数据处理，生成质控后的样方调查数据（L1级数据）和样地尺度的统计数据（L3级数据）。', NOW(), 'admin', b'1', NOW(), 'admin', 0 );
insert into `data_product_type` (`id`, `parent_id`, `level`, `name`, `description`, `crt_dttm`, `crt_user`, `enable_flag`, `last_update_dttm`, `last_update_user`, `version` ) values ('5','1', '2', '土壤要素观测数据产品', '土壤湿度、温度、质地、含水量、养分、酸碱度和侵蚀等要素的测量结果和分析信息', NOW(), 'admin', b'1', NOW(), 'admin', 0 );
insert into `data_product_type` (`id`, `parent_id`, `level`, `name`, `description`, `crt_dttm`, `crt_user`, `enable_flag`, `last_update_dttm`, `last_update_user`, `version` ) values ('6','1', '2', '水环境要素观测数据产品', '提供水文、水化学等要素的测量结果和分析信息', NOW(), 'admin', b'1', NOW(), 'admin', 0 );
insert into `data_product_type` (`id`, `parent_id`, `level`, `name`, `description`, `crt_dttm`, `crt_user`, `enable_flag`, `last_update_dttm`, `last_update_user`, `version` ) values ('7','2', '2', '生产力和固碳功能数据产品', '利用样地尺度的生物量、土壤有机质等统计数据（L3级数据），计算生成植被碳密度、土壤表层碳密度和剖面土壤有机碳密度数据产品（L4级数据）。', NOW(), 'admin', b'1', NOW(), 'admin', 0 );
insert into `data_product_type` (`id`, `parent_id`, `level`, `name`, `description`, `crt_dttm`, `crt_user`, `enable_flag`, `last_update_dttm`, `last_update_user`, `version` ) values ('8','2', '2', '水源涵养功能数据产品', '利用样地尺度的土壤含水量统计数据（L3级数据），计算生成0-20cm、0-90cm、剖面分层土壤蓄水量数据产品（L4级数据）。', NOW(), 'admin', b'1', NOW(), 'admin', 0 );
insert into `data_product_type` (`id`, `parent_id`, `level`, `name`, `description`, `crt_dttm`, `crt_user`, `enable_flag`, `last_update_dttm`, `last_update_user`, `version` ) values ('9','2', '2', '生物多样性功能数据产品', '利用经过质量控制后的森林乔木每木调查数据（L1级数据），分物种统计样地尺度的物种数据，计算物种丰富度、Shannon-Wiener指数、Simpson指数、Pielou指数（L4级数据）。', NOW(), 'admin', b'1', NOW(), 'admin', 0 );
insert into `data_product_type` (`id`, `parent_id`, `level`, `name`, `description`, `crt_dttm`, `crt_user`, `enable_flag`, `last_update_dttm`, `last_update_user`, `version` ) values ('10','2', '2', '土壤保持功能数据产品', '土壤保持功能', NOW(), 'admin', b'1', NOW(), 'admin', 0 );
insert into `data_product_type` (`id`, `parent_id`, `level`, `name`, `description`, `crt_dttm`, `crt_user`, `enable_flag`, `last_update_dttm`, `last_update_user`, `version` ) values ('11','2', '2', '防风固沙功能数据产品', '防风固沙功能', NOW(), 'admin', b'1', NOW(), 'admin', 0 );
insert into `data_product_type` (`id`, `parent_id`, `level`, `name`, `description`, `crt_dttm`, `crt_user`, `enable_flag`, `last_update_dttm`, `last_update_user`, `version` ) values ('12','3', '3', '地面气象要素数据产品', '气温、最高气温、最低气温、相对湿度、大气压、10min平均风速、降水量', NOW(), 'admin', b'1', NOW(), 'admin', 0 );
insert into `data_product_type` (`id`, `parent_id`, `level`, `name`, `description`, `crt_dttm`, `crt_user`, `enable_flag`, `last_update_dttm`, `last_update_user`, `version` ) values ('13','3', '3', '辐射数据产品', '总辐射曝辐量、总辐射辐射度、净辐射曝辐量、净辐射辐射度、光量子通量密度', NOW(), 'admin', b'1', NOW(), 'admin', 0 );
insert into `data_product_type` (`id`, `parent_id`, `level`, `name`, `description`, `crt_dttm`, `crt_user`, `enable_flag`, `last_update_dttm`, `last_update_user`, `version` ) values ('14','4', '3', '植物群落种类组成与物质生产数据产品', '生物量、物种组成、凋落物（森林、草地、水体）', NOW(), 'admin', b'1', NOW(), 'admin', 0 );
insert into `data_product_type` (`id`, `parent_id`, `level`, `name`, `description`, `crt_dttm`, `crt_user`, `enable_flag`, `last_update_dttm`, `last_update_user`, `version` ) values ('15','5', '3', '土壤化学性质数据产品', '土壤有机质（表面和剖面）', NOW(), 'admin', b'1', NOW(), 'admin', 0 );
insert into `data_product_type` (`id`, `parent_id`, `level`, `name`, `description`, `crt_dttm`, `crt_user`, `enable_flag`, `last_update_dttm`, `last_update_user`, `version` ) values ('16','6', '3', '水文要素数据产品', '土壤含水量（TDR、中子仪）', NOW(), 'admin', b'1', NOW(), 'admin', 0 );
insert into `data_product_type` (`id`, `parent_id`, `level`, `name`, `description`, `crt_dttm`, `crt_user`, `enable_flag`, `last_update_dttm`, `last_update_user`, `version` ) values ('17','6', '3', '水化学要素数据产品', '水质（待定）', NOW(), 'admin', b'1', NOW(), 'admin', 0 );