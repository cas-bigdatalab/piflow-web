...
(
    ...
    `description` varchar(512) NULL DEFAULT NULL COMMENT '参数描述',
...
insert into `data_product_type` (`id`, `parent_id`, `level`, `name`, `description`, `crt_dttm`, `crt_user`, `enable_flag`, `last_update_dttm`, `last_update_user`, `version` ) values ('6','1', '2', '土壤要素观测数据产品', '土壤要素', NOW(), 'admin', b'1', NOW(), 'admin', 0 );
insert into `data_product_type` (`id`, `parent_id`, `level`, `name`, `description`, `crt_dttm`, `crt_user`, `enable_flag`, `last_update_dttm`, `last_update_user`, `version` ) values ('7','1', '2', '水环境要素观测数据产品', '水环境要素', NOW(), 'admin', b'1', NOW(), 'admin', 0 );
