...
-- ----------------------------
INSERT INTO `sys_schedule`(`id`, `crt_dttm`, `crt_user`, `enable_flag`, `last_update_dttm`, `last_update_user`, `version`, `cron_expression`, `job_class`, `job_name`, `status`) VALUES ('ff8081816eaa8a5d016eaa8a77e40000', '2019-11-27 09:47:12', 'system', b'1', '2019-11-27 09:47:12', 'system', 0, '0/5 * * * * ?', 'RunningProcessSync', 'RunningProcessSync', 'RUNNING');
INSERT INTO `sys_schedule`(`id`, `crt_dttm`, `crt_user`, `enable_flag`, `last_update_dttm`, `last_update_user`, `version`, `cron_expression`, `job_class`, `job_name`, `status`) VALUES ('ff8081816eaa9317016eaa932dd50000', '2019-11-27 09:56:43', 'system', b'1', '2019-11-27 09:56:43', 'system', 0, '0/5 * * * * ?', 'RunningProcessGroupSync', 'RunningProcessGroupSync', 'RUNNING');
-- ----------------------------
-- update Example1
-- ----------------------------
