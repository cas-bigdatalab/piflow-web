...
CREATE TABLE  IF NOT EXISTS `vis_dataBase_info` (
                                     ...
                                     PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COMMENT='数据库信息';
...
CREATE TABLE  IF NOT EXISTS `vis_excel_name_asso` (
                                       ...
                                       PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=27 DEFAULT CHARSET=utf8mb4 COMMENT='excel表名关联信息';
...
CREATE TABLE  IF NOT EXISTS `vis_graph_conf` (
                                  ...
                                  `update_time` varchar(255) NOT NULL COMMENT '更新时间',
                                  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=100 DEFAULT CHARSET=utf8mb4 COMMENT='图表配置表';
...
CREATE TABLE  IF NOT EXISTS `vis_graph_template` (
                                      ...
                                      `reserve2` varchar(255) DEFAULT NULL COMMENT '备用字段1',
                                      PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8mb4 COMMENT='图表模板信息';
...
CREATE TABLE  IF NOT EXISTS `vis_product_template_graph_asso` (
                                                   ...
                                                   `create_time` varchar(255) NOT NULL COMMENT '创建时间',
                                                   PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=94 DEFAULT CHARSET=utf8mb4 COMMENT='数据产品关联表';