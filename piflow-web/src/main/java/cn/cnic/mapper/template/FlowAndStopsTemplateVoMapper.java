...
import cn.cnic.provider.template.FlowAndStopsTemplateVoMapperProvider;
...
public interface FlowAndStopsTemplateVoMapper {
    ...
    @Results({@Result(id = true, column = "id", property = "id"),
            @Result(column = "id", property = "properties", many = @Many(select = "cn.cnic.mapper.template.FlowAndStopsTemplateVoMapper.getPropertyListByStopsId", fetchType = FetchType.EAGER))
