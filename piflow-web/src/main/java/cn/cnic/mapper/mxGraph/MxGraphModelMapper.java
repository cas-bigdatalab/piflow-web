...
import cn.cnic.provider.mxGraph.MxGraphModelProvider;
...
public interface MxGraphModelMapper {
    ...
    @Results({@Result(id = true, column = "id", property = "id"),
            ...
            @Result(column = "id", property = "root", many = @Many(select = "cn.cnic.mapper.mxGraph.MxCellMapper.getMeCellByMxGraphId", fetchType = FetchType.LAZY))})
