...
import cn.cnic.provider.flow.PropertyMapperProvider;
...
public interface PropertyMapper {
    ...
    @Results({
            ...
            @Result(property = "properties", column = "id", many = @Many(select = "cn.cnic.mapper.flow.PropertyMapper.getPropertyBySotpsId", fetchType = FetchType.LAZY)),
            @Result(property = "customizedPropertyList", column = "id", many = @Many(select = "cn.cnic.mapper.flow.CustomizedPropertyMapper.getCustomizedPropertyListByStopsId", fetchType = FetchType.LAZY))})
