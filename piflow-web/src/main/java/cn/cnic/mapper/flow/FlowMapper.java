...
import cn.cnic.provider.flow.FlowMapperProvider;
...
public interface FlowMapper {
    ...
    @Results({
            ...
            @Result(column = "fk_flow_group_id", property = "flowGroup", one = @One(select = "cn.cnic.mapper.flow.FlowGroupMapper.getFlowGroupById", fetchType = FetchType.LAZY)),
            @Result(column = "id", property = "mxGraphModel", one = @One(select = "cn.cnic.mapper.mxGraph.MxGraphModelMapper.getMxGraphModelByFlowId", fetchType = FetchType.LAZY)),
            @Result(column = "id", property = "stopsList", many = @Many(select = "cn.cnic.mapper.flow.StopsMapper.getStopsListByFlowId", fetchType = FetchType.LAZY)),
            @Result(column = "id", property = "pathsList", many = @Many(select = "cn.cnic.mapper.flow.PathsMapper.getPathsListByFlowId", fetchType = FetchType.LAZY))
