...
import cn.cnic.provider.process.ProcessStopMapperProvider;
...
public interface ProcessStopMapper {
    ...
    @Results({
            ...
            @Result(column = "id", property = "processStopPropertyList", many = @Many(select = "cn.cnic.mapper.process.ProcessStopPropertyMapper.getStopPropertyByProcessStopId", fetchType = FetchType.LAZY))
