...
public interface StopGroupMapper {
    ...
    @Results({@Result(id = true, column = "id", property = "id"),
            @Result(column = "id", property = "stopsTemplateList", many = @Many(select = "cn.cnic.component.stopsComponent.mapper.StopsTemplateMapper.getStopsTemplateListByGroupId"))})
    ...
    @Select("<script>" +
            ...
            "</foreach>" +
            "</script>")
    List<StopsComponentGroup> getStopGroupByName(@Param("group_name") List<String> groupName);
