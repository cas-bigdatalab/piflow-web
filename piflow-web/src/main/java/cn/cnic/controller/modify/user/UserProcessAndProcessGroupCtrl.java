...
@Controller
@RequestMapping("/user/processAndProcessGroup")
public class UserProcessAndProcessGroupCtrl {
    ...
    public String processAndProcessGroupListPage(HttpServletRequest request, Integer page, Integer limit, String param) {
        ...
        return processAndProcessGroupServiceImpl.getProcessAndProcessGroupListPage(username, false, page, limit, param);
    }
    ...
    public String stopProcessOrProcessGroup(HttpServletRequest request) {
        ...
        String username = SessionUserUtil.getUsername(request);
        if ("PROCESS".equals(processType)) {
            return processServiceImpl.stopProcess(username, false, id);
        } else {
            return processGroupServiceImpl.stopProcessGroup(username, false, id);
        }
    }
    ...
    public String delProcessGroup(HttpServletRequest request) {
        ...
        if ("PROCESS".equals(processType)) {
            ...
            return processGroupServiceImpl.delProcessGroup(username, false, id);
        }
    }
