 ...
 */
@RestController
@RequestMapping("/admin/flowTemplate")
public class AdminFlowTemplateCtrl {
    ...
    public String templatePage(HttpServletRequest request, Integer page, Integer limit, String param) {
        String username = SessionUserUtil.getUsername(request);
        return flowTemplateServiceImpl.getFlowTemplateListPage(username, true, page, limit, param);
    }
    ...
    public String flowTemplateList(HttpServletRequest request) {
        String username = SessionUserUtil.getUsername(request);
        return flowTemplateServiceImpl.flowTemplateList(username, true);
    }
