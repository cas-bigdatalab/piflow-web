...
public interface PropertyMapper {
	...
	public int updateStops(@Param("name") String content,@Param("display_name") String display_name,@Param("custom_value") String custom_value,@Param("description") String description,@Param("version") String version, @Param("id") String id);
}
