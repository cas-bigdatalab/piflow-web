...
import com.nature.provider.flow.CustomizedPropertyMapperProvider;
...
public interface CustomizedPropertyMapper {
    ...
    @Results({
            @Result(column = "fk_stops_id", property = "stops", many = @Many(select = "com.nature.mapper.flow.StopsMapper.getStopsById", fetchType = FetchType.LAZY))
    })
