...
public class StopPropertyTemplateVo implements Serializable {
	/**
	 * stop属性模板
	 */
	...
	private StopTemplateVo stopTemplateVo;
	...
	public StopTemplateVo getStopTemplateVo() {
		return stopTemplateVo;
	}

	public void setStopTemplateVo(StopTemplateVo stopTemplateVo) {
		this.stopTemplateVo = stopTemplateVo;
	}
