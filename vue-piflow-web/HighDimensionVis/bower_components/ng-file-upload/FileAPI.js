	...
	var
		...
		api = {
			...
			accept: {
				...
				, 'video/*': 'm4v 3gp nsv ts ty strm rm rmvb m3u ifo mov qt divx xvid bivx vob nrg images iso pva wmv asf asx ogm m2v avi bin dat dvr-ms mpg mpeg mp4 mkv avc vp3 svq3 nuv viv dv fli flv wpl'
			},
			 ...
			 *
			 * @param {String} [src]
			 * @param {Function} [fn]   1. error -- boolean, 2. images -- Image element
			 * @returns {HTMLElement}
			 */
