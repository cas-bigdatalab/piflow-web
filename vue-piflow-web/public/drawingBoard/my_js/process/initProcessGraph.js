...
function initMonitorIcon() {
    ...
    setTimeout(() => {
        ...
        nodeArr.forEach(item => {
            ...
            img_element_init.href.baseVal = "/drawingBoard/img/Loading.gif";
            ...
            img_element_ok.href.baseVal = "/drawingBoard/img/Ok.png";
            ...
            img_element_fail.href.baseVal = "/drawingBoard/img/Fail.png";
